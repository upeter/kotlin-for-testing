...
fun <S : RestTestClient.RequestHeadersSpec<S>> S.correlationIdHeader(correlationId: String = "default-correlationId"): S =
...
fun <S : RestTestClient.RequestHeadersSpec<S>> S.defaultHeaders(
    ...
    correlationId: String = "default-correlationId",
